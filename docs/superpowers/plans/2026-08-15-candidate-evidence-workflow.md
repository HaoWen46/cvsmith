...
- [x] **Step 1: Add the failing catalog and behavioral-scenario tests**
...
- [x] **Step 3: Run a fresh-agent baseline without the new skill**
...
- [x] **Step 4: Initialize the skill scaffold, then retain only required files**
...
- [x] **Step 5: Write the minimal skill and workspace contract**
...
- [x] **Step 6: Add trigger cases that distinguish evidence intake from resume construction**
...
- [x] **Step 7: Run GREEN checks and one with-skill forward test**
...
- [x] **Step 8: Commit the new skill slice**
...
- Modify: `skills/resume-builder/references/writing-rules.md`
- Modify: `skills/resume-builder/references/regional.md`
- Modify: `skills/resume-builder/assets/templates/data-schema.md`
...
- [x] **Step 1: Add failing integrated behavior assertions**
...
- [x] **Step 2: Run the integrated scenario tests and verify RED**
...
- [x] **Step 3: Remove intake and archive ownership from `resume-builder`**
...
- [x] **Step 4: Remove the obsolete monolithic reference and clarify sibling boundaries**

Delete `skills/resume-builder/references/career-vault.md`; replace its remaining terminology in the builder's always-read schema and writing rules with candidate evidence while retaining `meta.vault` only as the compatibility field name; make `jd-analyzer` state that every brief is separate, temporary, and disposable; make `resume-evaluator` accept the evidence index and selected evidence documents; make `application-tracker` live beside the evidence workspace and not require a retained full JD.

- [x] **Step 5: Run GREEN checks and an integrated fresh-agent case**
...
- [x] **Step 6: Commit the handoff slice**

Run: `git commit --only -m "refactor: separate evidence intake from resume building" -- skills/resume-builder/SKILL.md skills/resume-builder/references/career-vault.md skills/resume-builder/references/writing-rules.md skills/resume-builder/references/regional.md skills/resume-builder/assets/templates/data-schema.md skills/jd-analyzer/SKILL.md skills/resume-evaluator/SKILL.md skills/application-tracker/SKILL.md evals/trigger-eval-resume-builder.json evals/evals.json`
...
- [x] **Step 1: Update the public workflow without adding architecture prose**
...
- [x] **Step 2: Record only measured behavior**
...
- [x] **Step 4: Package and inspect all skills**
...
- [x] **Step 5: Render and visually inspect the flagship artifact**
...
- [x] **Step 6: Review the final diff against the scope ceiling**
...
- [x] **Step 7: Commit the product-surface slice**
