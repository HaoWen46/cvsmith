"""Shared result plumbing for the evaluator scripts.

Every script builds a Report of Checks, prints it (human text by default,
--json for machines), and exits 0 when nothing FAILed, 1 otherwise.
Deterministic layers must be scripts, not eyeballs — so the output format
is stable enough for an agent to parse either way.
"""
