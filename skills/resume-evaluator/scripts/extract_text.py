...
# ]
# ///
"""L0 — check whether common extractors recover a healthy text layer.

Runs pypdf and, when installed, Poppler's pdftotext; disagreement is an
interoperability warning or failure, not a prediction about an employer.
...
def main() -> int:
    ...
    if chars < MIN_CHARS:
        report.add("text_layer", FAIL,
                   ...
                   "image-based or empty text layer")
    else:
